...
<div class="w3-top">
 ...
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="upload.html" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover" title="upload img"><i class="fa fa-upload"></i></a>
  ...
  <a href="myacc.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-theme-d4 w3-padding-large w3-hover" title="My Account">
...
<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <a href="myacc.php" class="w3-bar-item w3-button w3-padding-xlarge">My Profile</a>
</div>
      ...
      if(isset($_POST['submit']))
	   {
	       ...
	       $d=$_POST["sdis"]; 
		      ...
		      $sql="SELECT * FROM upload  WHERE area = '$a' || district = '$d' ORDER BY id DESC ";
                 $res=$conn->query($sql);
                 while($row = mysqli_fetch_array($res, MYSQL_ASSOC))  
                {  
				    ...
				    echo '<img src="https://www.w3schools.com/w3images/avatar2.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
                                  ...
                                  <h4 class="w3-left w3-clear w3-margin-top"><a href="viewprofile.php?link1=' .$row['uname'].'&link2='.$row['email'].'">'.$row['uname'].'</a></h4><br><br><span class=" w3-right w3-clear  w3-opacity">'.$row['email'].'</span><br>
                                  <hr class="w3-clear">';
        ...
        <button type="button" class="w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i> ?Comment</button><br> ';	
		              echo '<form method="post" action="cmnt.php">
					       <input type="text" name="com" placeholder="Your Comment here...." style="border-radius:4px; width:500px;" >
						   <input type="submit">';
